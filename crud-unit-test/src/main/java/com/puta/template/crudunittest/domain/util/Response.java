package com.puta.template.crudunittest.domain.util;
...
public class Response {
    ...
    public static <T> ResponseEntity<Object> build(String responseMessage, T data, Set<String> errors, HttpStatus httpStatus){
        return new ResponseEntity<>(buildResponse(String.valueOf(httpStatus.value()), responseMessage, data, errors), httpStatus);
    }

    static <T> ApiResponse<T> buildResponse(String responseCode, String responseMessage, T data, Set<String> errors){
